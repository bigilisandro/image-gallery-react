...
const ModalImage: React.FC<ModalImageProps> = ({ image, show, handleClose }) => {

  return (
    <>
      <Modal dialogClassName="modal-fit-content" contentClassName="bg-secondary" size="lg" show={show} onHide={handleClose}>
